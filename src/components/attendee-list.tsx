                ...
                <thead>
                    <tr className="border-b border-white">
                        <th className="py-3 px-4 text-sm font-semibold text-left">
                            <input type="checkbox" className="size-4 bg-black/20 rounded border-white/10 accent-orange" />
                        </th>
                            ...
                            <tr key={i} className="border-b border-white/10 hover:bg-white/5">
                                ...
                                <td className="py-3 px-4 text-sm text-zinc-300">
                                    <div className="flex flex-col gap-1">
                                        <span className="font-semibold text-white">Gustavo Schmid de Jesus</span>
                                        <span>gutors@gmail.com</span>
                                    </div>
                                </td>
                                <td className="py-3 px-4 text-sm text-zinc-300">01/01/2021</td>
                                <td className="py-3 px-4 text-sm text-zinc-300">01/01/2021</td>
                                <td className="py-3 px-4 text-sm text-zinc-300">
